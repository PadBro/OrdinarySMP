  ...
  <div class="bg-white">
    <main>
      ...
      <div class="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
        <img src="~/assets/image.png" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover" />
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
              <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-black ring-1 bg-gray-200/80 ring-white/10 hover:ring-white/20">
                Join at {{ serverSubdomain }}.{{ domain }}.
              </div>
            </div>
            <div class="text-center">
              <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Ordinary SMP</h1>
              <p class="mt-6 text-lg leading-8 text-gray-300">Ordinary SMP is a Vanilla Whitelisted SMP with a diverse Player base from all arround the World.</p>
              <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="#" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Join our Discord</a>
...
const serverSubdomain = useRuntimeConfig().public.serverSubdomain;
...
const features = [
  ...
  {
    name: 'Player-Driven Economy.',
    description: 'Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.',
    icon: LockClosedIcon,
  },
  {
    name: 'Diverse Player base.',
...
const faqs = [
  ...
  {
    question: "Where do i find the Server Adress?",
    answer:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.",
  },
  {
    question: "Do i need any mods?",
    answer:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.",
  },
  // More questions...
